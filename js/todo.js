...
export function updateTodo(todoId, content, done, token) {
  return fetch(API_URL, {
    method: 'POST',
    headers: {
      'Content-Type': 'application/json',
    ...
    body: JSON.stringify({
      ...
      variables: {
        ...
        "update": {
          "content": content, // Le texte de la todo avec l'image si nécessaire
          "done": done // Un booléen pour indiquer si c'est terminé
        }
      }
    })
  })
